...
int main(int argc, char *argv[]) {
    ...
    int num_processes = get_env_int("OMPI_COMM_WORLD_SIZE", 1);
    int process_rank = get_env_int("OMPI_COMM_WORLD_RANK", 0);
    int gpus_per_node = get_env_int("OMPI_COMM_WORLD_LOCAL_SIZE", 1);
    char dfs_path[256] = ".";

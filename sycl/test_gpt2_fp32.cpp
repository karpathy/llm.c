...
#include "train_gpt2_fp32.dp.cpp"
#include <cmath>
...
int main(int argc, char *argv[]) {
    ...
    int deviceIdx = 0;
    /*
    DPCT1093:536: The "deviceIdx" device may be not the one intended for use.
    ...
    */
    ...
    /*
    DPCT1007:537: Migration of cublasLtCreate is not supported.
    */
    cublasCheck(cublasLtCreate(&cublaslt_handle));
    // TF32 precision is equivalent to torch.set_float32_matmul_precision('high')
    /*
    DPCT1005:538: The SYCL device version is different from CUDA Compute
    ...
    */
    ...
    /*
    DPCT1027:539: The call to cublasSetMathMode was replaced with 0 because this
    ...
    */
    ...
    dpct::get_in_order_queue()
        .memcpy(logits_cpu, model.acts.output, B * T * Vp * sizeof(float))
        .wait();
    ...
    for (int step = 0; step < 10; step++) {
        ...
        if (step == 0) {
            ...
            dpct::get_in_order_queue()
                .memcpy(calculated_grads_memory, model.grads_memory,
    ...
    /*
    DPCT1007:540: Migration of cublasLtDestroy is not supported.
    */
